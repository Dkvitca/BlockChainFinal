...
contract Election {
    ...
    struct ElectionDetails {
        ...
        uint256 electionStartDate; // Renamed to avoid shadowing
        uint256 electionEndDate;   // Renamed to avoid shadowing
    }
    ...
    )
    {
        return(
            ...
            electionDetails.electionStartDate, // Return the startDate
            electionDetails.electionEndDate   // Return the endDate
            );
    }
